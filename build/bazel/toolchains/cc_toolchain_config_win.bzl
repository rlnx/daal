    ...
    default_link_flags_feature = feature(
        ...
        flag_sets = [
            flag_set(
                actions = all_link_actions,
                flag_groups = ([
                    flag_group(flags = ctx.attr.link_flags_cc)
    ...
    dbg_feature = feature(
        ...
        flag_sets = [
            ...
            flag_set(
                ...
                flag_groups = [
                    flag_group(
                        flags = ctx.attr.dbg_compile_flags + ["/INCREMENTAL:NO"],
                    ),
                ],
            ),
        ],
...
cc_toolchain_config = rule(
    ...
    attrs = {
        ...
        "msvc_env_lib": attr.string(),
        "msvc_env_include": attr.string(),
        "msvc_env_path": attr.string(),
